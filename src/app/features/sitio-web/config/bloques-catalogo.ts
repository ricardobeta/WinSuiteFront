...
export const BLOQUES_CATALOGO: DefinicionBloque[] = [
  ...
  },
  {
    ...
    icono: 'quiz',
    descripcion: 'Acordeon de preguntas y respuestas.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'faq',
      ...
      items: [
        { pregunta: '¿Hacen envios a todo el pais?', respuesta: 'Si, trabajamos con courier a nivel nacional.' },
        { pregunta: '¿Cuales son los metodos de pago?', respuesta: 'Tarjeta, transferencia y efectivo contra entrega.' },
      ],
    }),
  },
  {
    ...
    nombre: 'Franja CTA',
    icono: 'campaign',
    descripcion: 'Banda destacada con titulo y boton de accion.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'cta',
      titulo: '¿Listo para empezar?',
      texto: 'Aprovecha la promocion de este mes.',
  ...
  },
  {
    ...
    icono: 'stars',
    descripcion: 'Beneficios con icono, titulo y texto corto.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'caracteristicas',
      ...
      columnas: 3,
      items: [
        { icono: '🚀', titulo: 'Entrega rapida', texto: 'Recibe tu pedido en 24-48 horas.' },
        { icono: '🛡️', titulo: 'Garantia real', texto: 'Devoluciones sin preguntas por 30 dias.' },
        { icono: '💬', titulo: 'Soporte humano', texto: 'Te atendemos por WhatsApp todos los dias.' },
      ],
    }),
  },
  {
    tipo: 'logos',
    categoria: 'contenido',
    nombre: 'Logos de clientes',
    icono: 'handshake',
    descripcion: 'Marcas que confian en ti (grises, color al hover).',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'logos',
      titulo: 'Confian en nosotros',
      imagenes: [
        { url: 'https://placehold.co/150x52?text=Logo+1' },
        { url: 'https://placehold.co/150x52?text=Logo+2' },
        { url: 'https://placehold.co/150x52?text=Logo+3' },
      ],
      gris: true,
    }),
  },
  {
    ...
    nombre: 'Estadisticas',
    icono: 'trending_up',
    descripcion: 'Cifras grandes animadas al hacer scroll.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'estadisticas',
  ...
  },
  {
    ...
    nombre: 'Equipo',
    icono: 'groups',
    descripcion: 'Personas con foto, nombre y cargo.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'equipo',
      ...
      columnas: 3,
      items: [
        { nombre: 'Nombre Apellido', cargo: 'Fundador/a' },
        { nombre: 'Nombre Apellido', cargo: 'Ventas' },
        { nombre: 'Nombre Apellido', cargo: 'Soporte' },
      ],
    }),
  },
  {
    ...
    icono: 'timer',
    descripcion: 'Countdown a una fecha (ofertas, eventos, lanzamientos).',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'countdown',
  ...
  },
  {
    ...
    nombre: 'Espaciador',
    icono: 'height',
    descripcion: 'Aire vertical ajustable, con linea divisoria opcional.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'espaciador',
