...
export const BLOQUES_CATALOGO: DefinicionBloque[] = [
  ...
  },
  {
    ...
    crearPorDefecto: (id) => ({
      ...
      mapaLado: 'izquierda',
      titulo: 'Visitanos',
      descripcion: 'Estamos listos para atenderte.',
      lat: -0.1807,
      lng: -78.4678,
      zoom: 15,
      textoAbrirMapa: 'Abrir indicaciones',
      direccion: 'Quito, Ecuador',
      telefono: '+593 99 000 0000',
      horario: 'Lunes a viernes · 09:00–18:00',
      textoBoton: 'Escribenos',
  ...
  },
  {
    ...
    icono: 'timeline',
    descripcion: 'Explica compra, confirmación, pago y entrega en una ruta editable.',
    crearPorDefecto: (id) => ({
      id,
      visible: true,
      tipo: 'proceso-compra',
      titulo: 'Así funciona tu compra',
      descripcion: 'Conoce cada etapa desde tu elección hasta la entrega.',
      etiquetaPaso: 'Paso',
      items: [
        {
          icono: '🛍️',
          titulo: 'Elige y solicita',
          texto: 'Selecciona el producto o servicio y registra tus datos.',
        },
        {
          icono: '✅',
          titulo: 'Recibe la confirmación',
          texto: 'El negocio revisa la solicitud y confirma los siguientes pasos.',
        },
        {
          icono: '💳',
          titulo: 'Completa el pago',
          texto: 'Selecciona uno de los métodos de pago disponibles.',
        },
        {
          icono: '📦',
          titulo: 'Recibe tu compra',
          texto: 'Recibe el producto, acceso o servicio según la modalidad acordada.',
        },
      ],
    }),
  },
